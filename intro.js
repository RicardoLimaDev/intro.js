...
(function (root, factory) {
  ...
  function IntroJs(obj) {
    ...
    this._options = {
      ...
      positionPrecedence: ["bottom", "top", "right", "left", "top-middle", "top-left", "bottom-middle", "bottom-left", "bottom-right", "bottom-left-aligned","bottom-right-aligned"],
  ...
  */
  ...
  function _placeTooltip(targetElement, tooltipLayer, arrowLayer, helperNumberLayer, hintMode) {
    ...
    switch (currentTooltipPosition) {
      ...
      case 'bottom-left':
        arrowLayer.className = 'introjs-arrow top-right';
        tooltipLayer.style.right = 0 + 'px'
        tooltipLayer.style.top = (targetOffset.height + 20) + 'px';
      break;

      case 'top-middle':
        arrowLayer.className = 'introjs-arrow bottom-middle';
        tooltipLayer.style.left = -(tooltipOffset.width/2) + 20 + 'px'
  ...
  function _determineAutoPosition(targetElement, tooltipLayer, desiredTooltipPosition) {
    ...
    if (targetOffset.left + targetOffset.width + tooltipWidth > windowSize.width) 
    {
    ...
    if ((targetOffset.top + targetOffset.height) + tooltipHeight > windowSize.height) 
    {
      _removeEntry(possiblePositions, "bottom");
      _removeEntry(possiblePositions, "bottom-middle");
    }

    if(desiredTooltipPosition == "top-middle")
    {
      //Check for right space
      if ( (targetOffset.left + (targetOffset.width/2) ) + (tooltipWidth/2) > windowSize.width) 
      {
        _removeEntry(possiblePositions, "top-middle");
        _removeEntry(possiblePositions, "bottom-middle");
      ...
      if ( (targetOffset.left + (targetOffset.width/2) ) - (tooltipWidth/2) < 0) 
      {
        _removeEntry(possiblePositions, "top-middle");
        _removeEntry(possiblePositions, "bottom-middle");
